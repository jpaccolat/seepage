...
# Internal imports
from rate_numba import q_exact
from rate_numba import q_approx
from rate_numba import q_exact_full
from rate_numba import q_approx_full
from rate_numba import q_modflow
import rose
...
def compile_numba(aq_para):
    _ = q_approx_full(1, 1e-5, 0.1, 1e-4, 0.1, 2.3, aq_para)

def run(args):
    """Run experiment 4."""

    compile_numba(args.aq_para)
...
def main():
    ...
    if args.output is None:
        args.output = f'exp6_numba_{args.aq_para}_{args.texture}'
