...
# def jac_vGM(psi, hg, n):
#     jac = np.zeros_like(psi)
#     idx = psi > hg
#     rhc = relative_hydraulic_conductivity_vGM(psi[idx], hg, n)
#     jac[idx] = -rhc / psi[idx] * Phi(psi[idx], hg, n)
#     return jac
...
# def jac_BCB(psi, hg, lam):
#     jac = np.zeros_like(psi)
#     idx = psi > hg
#     rhc = relative_hydraulic_conductivity_BCB(psi[idx], hg, lam)
#     jac[idx] = -rhc / psi[idx] * (2 + 3 * lam)
#     return jac